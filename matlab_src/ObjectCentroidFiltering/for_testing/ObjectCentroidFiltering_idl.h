...
#ifndef __ObjectCentroidFiltering_idl_h__
#define __ObjectCentroidFiltering_idl_h__
...
EXTERN_C const IID IID_IClass1;
    ...
    MIDL_INTERFACE("6E84E08A-CF10-442E-A90E-2B787664B24B")
    ...
    public:
        ...
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE find_object_centroids( 
            /* [in] */ long nargout,
            /* [out][in] */ VARIANT *outputImg,
            /* [out][in] */ VARIANT *outputCentroids,
            /* [in] */ VARIANT img) = 0;
    ...
    typedef struct IClass1Vtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *find_object_centroids )( 
            IClass1 * This,
            /* [in] */ long nargout,
            /* [out][in] */ VARIANT *outputImg,
            /* [out][in] */ VARIANT *outputCentroids,
...
#define IClass1_find_object_centroids(This,nargout,outputImg,outputCentroids,img)	\
    ( (This)->lpVtbl -> find_object_centroids(This,nargout,outputImg,outputCentroids,img) ) 
...
#ifndef __ObjectCentroidFiltering_LIBRARY_DEFINED__
#define __ObjectCentroidFiltering_LIBRARY_DEFINED__

/* library ObjectCentroidFiltering */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_ObjectCentroidFiltering;

EXTERN_C const CLSID CLSID_Class1;

#ifdef __cplusplus

class DECLSPEC_UUID("214B5135-C26F-48D7-9FB7-598C8CC1289B")
Class1;
#endif
#endif /* __ObjectCentroidFiltering_LIBRARY_DEFINED__ */
